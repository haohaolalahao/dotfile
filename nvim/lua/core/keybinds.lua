...
-- 修改分屏大小
vim.keybinds.gmap("n", "<A-k>", "<cmd>res +1<CR>", vim.keybinds.opts)
vim.keybinds.gmap("n", "<A-j>", "<cmd>res -1<CR>", vim.keybinds.opts)
vim.keybinds.gmap("n", "<A-h>", "<cmd>vertical resize-1<CR>", vim.keybinds.opts)
vim.keybinds.gmap("n", "<A-l>", "<cmd>vertical resize+1<CR>", vim.keybinds.opts)
